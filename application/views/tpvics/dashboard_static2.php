                                    ...
                                    <div class="box box-widget widget-user-2">
                                        ...
                                        <?php if ($this->users->in_group('admin') || $this->users->in_group('management')) { ?>
                                            <div class="box-footer no-padding">
                                                <ul class="nav nav-stacked">
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d' ?>"><strong>KHYBER
                                                                PAKHTUNKHWA</strong><span
                                                                    class="pull-right badge bg-orange">0</span></a></li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d' ?>"><strong>PUNJAB</strong><span
                                                                    class="pull-right badge bg-orange">0</span></a></li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d' ?>"><strong>SINDH</strong><span
                                                                    class="pull-right badge bg-orange">0</span></a></li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d' ?>"><strong>BALOCHISTAN</strong><span
                                                                    class="pull-right badge bg-orange">0</span></a></li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d' ?>"><strong>FATA</strong><span
                                                                    class="pull-right badge bg-orange">0</span></a></li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d' ?>"><strong>FEDERAL
                                                                CAPITAL</strong><span
                                                                    class="pull-right badge bg-orange">0</span></a></li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d' ?>"><strong>GILGIT
                                                                BALTISTAN</strong><span
                                                                    class="pull-right badge bg-orange">0</span></a></li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d' ?>"><strong>AZAD
                                                                JAMMU</strong><span
                                                                    class="pull-right badge bg-orange">0</span></a></li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d' ?>"><strong>ADJACENT
                                    ...
                                    <div class="box box-widget widget-user-2">
                                        ...
                                        <?php if ($this->users->in_group('admin') || $this->users->in_group('management')) { ?>
                                            <div class="box-footer no-padding">
                                                <ul class="nav nav-stacked">
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/cc_d1'; ?>"><strong>KHYBER
                                                                PAKHTUNKHWA</strong><span
                                                                    class="pull-right badge bg-green"><?php echo $cc_d1; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/cc_d2'; ?>"><strong>Punjab</strong><span
                                                                    class="pull-right badge bg-green"><?php echo $cc_d2; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/cc_d3'; ?>"><strong>SINDH</strong><span
                                                                    class="pull-right badge bg-green"><?php echo $cc_d3; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/cc_d4'; ?>"><strong>BALOCHISTAN</strong><span
                                                                    class="pull-right badge bg-green"><?php echo $cc_d4; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/cc_d5'; ?>"><strong>FATA</strong><span
                                                                    class="pull-right badge bg-green"><?php echo $cc_d5; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/cc_d6'; ?>"><strong>FEDERAL
                                                                CAPITAL</strong><span
                                                                    class="pull-right badge bg-green"><?php echo $cc_d6; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/cc_d7'; ?>"><strong>GILGIT
                                                                BALTISTAN</strong><span
                                                                    class="pull-right badge bg-green"><?php echo $cc_d7; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/cc_d8'; ?>"><strong>AZAD
                                                                JAMMU</strong><span
                                                                    class="pull-right badge bg-green"><?php echo $cc_d8; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/cc_d9'; ?>"><strong>ADJACENT
                                                                AREAS-FR</strong><span
                                    ...
                                    <div class="box box-widget widget-user-2">
                                        ...
                                        <?php if ($this->users->in_group('admin') || $this->users->in_group('management')) { ?>
                                            <div class="box-footer no-padding">
                                                <ul class="nav nav-stacked">
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d1'; ?>"><strong>KHYBER
                                                                PAKHTUNKHWA</strong><span
                                                                    class="pull-right badge bg-red"><?php echo $rc_d1; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d2'; ?>"><strong>Punjab</strong><span
                                                                    class="pull-right badge bg-red"><?php echo $rc_d2; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d3'; ?>"><strong>SINDH</strong><span
                                                                    class="pull-right badge bg-red"><?php echo $rc_d3; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d4'; ?>"><strong>BALOCHISTAN</strong><span
                                                                    class="pull-right badge bg-red"><?php echo $rc_d4; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d5'; ?>"><strong>FATA</strong><span
                                                                    class="pull-right badge bg-red"><?php echo $rc_d5; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d6'; ?>"><strong>FEDERAL
                                                                CAPITAL</strong><span
                                                                    class="pull-right badge bg-red"><?php echo $rc_d6; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d7'; ?>"><strong>GILGIT
                                                                BALTISTAN</strong><span
                                                                    class="pull-right badge bg-red"><?php echo $rc_d7; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d8'; ?>"><strong>AZAD
                                                                JAMMU</strong><span
                                                                    class="pull-right badge bg-red"><?php echo $rc_d8; ?></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'tpvics/dashboard/rc_d9'; ?>"><strong>ADJACENT
                                                                AREAS-FR</strong><span
