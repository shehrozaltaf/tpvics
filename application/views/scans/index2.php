                                        ...
                                        <?php if ($this->users->in_group('admin') || $this->users->in_group('management')) { ?>
                                            <div class="box-footer no-padding">
                                                <ul class="nav nav-stacked">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo base_url() . 'index.php/tpvics/index/d6_c'; ?>"><strong>FEDERAL CAPITAL</strong><span
                                                    ...
                                                    <li>
                                                        <a href="<?php echo base_url() . 'index.php/tpvics/index/d8_c'; ?>"><strong>AZAD JAMMU</strong><span
