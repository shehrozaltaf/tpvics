                ...
                <tbody>
                    ...
                    foreach($get_list->result() as $row2){ 
                      ...
                      if($this->users->in_group('admin') || $this->users->in_group('management')){
                        $anchor = anchor("scans/systematic_randomizer2/".$row2->cluster_no."/".$this->uri->segment(3), '<i class="fa fa-edit"></i> Randomize', 'class="btn-sm btn-primary"');
                      } else {
                        $anchor = anchor("scans/systematic_randomizer2/".$row2->cluster_no, '<i class="fa fa-edit"></i> Randomize', 'class="btn-sm btn-primary"');
                      }      
