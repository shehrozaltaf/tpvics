                                        ...
                                        <?php if($this->users->in_group('admin') || $this->users->in_group('management')){ ?>
                                            <div class="box-footer no-padding">
                                                <ul class="nav nav-stacked">
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>AZAD JAMMU & KASHMIR</strong><span class="pull-right badge bg-blue">580</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>BALOCHISTAN</strong><span class="pull-right badge bg-blue">2112</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>GILGIT-BALTISTAN</strong><span class="pull-right badge bg-blue">433</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>KHYBER PAKHTUNKHWA</strong><span class="pull-right badge bg-blue">1853</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>PUNJAB</strong><span class="pull-right badge bg-blue">1839</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>ISLAMABAD</strong><span class="pull-right badge bg-blue">113</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>SINDH</strong><span class="pull-right badge bg-blue">1856</span></a></li>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="box box-widget widget-user-2">
                                        ...
                                        <?php if($this->users->in_group('admin') || $this->users->in_group('management')){ ?>
                                            <div class="box-footer no-padding">
                                                <ul class="nav nav-stacked">
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>AZAD JAMMU & KASHMIR</strong><span class="pull-right badge bg-green">0</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>BALOCHISTAN</strong><span class="pull-right badge bg-green">0</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>GILGIT-BALTISTAN</strong><span class="pull-right badge bg-green">0</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>KHYBER PAKHTUNKHWA</strong><span class="pull-right badge bg-green">0</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>PUNJAB</strong><span class="pull-right badge bg-green">0</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>ISLAMABAD</strong><span class="pull-right badge bg-green">0</span></a></li>
                                                    <li><a href="<?php echo base_url().'scans/dashboard'?>"><strong>SINDH</strong><span class="pull-right badge bg-green">0</span></a></li>
                                                </ul>
                                            </div>
                                        <?php } ?>
